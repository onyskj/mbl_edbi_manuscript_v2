...
results_nt_hc = readtable("fitted_data/fitted_ind_params_df_2021_09_21_00_51_49_HC_NT_niter_4000_foerde_alter_2_JO_wrong_ship_newexc.csv");
results_tr_hc = readtable("fitted_data/fitted_ind_params_df_2021_09_21_02_17_29_HC_BID_niter_4000_foerde_alter_2_JO_wrong_ship_newexc.csv");
...
for i=1:length(subject_info_summary_qs)
    ...
    subject_info_summary_qs{i}=array2table(subject_info_summary_qs{i},'VariableNames',{'mean','std','SE'},'RowNames',{'EAT-26', 'AAI', 'OCI-R','weight', 'height', 'bmi','age'});
end
...
dem_qs_stat_tests = array2table(dem_qs_stat_tests,'VariableNames',{'p-value','t-value','sd'},'RowNames',{'EAT-26', 'AAI', 'OCI-R', 'weight', 'height', 'bmi','age'});
...
scores_for_corr = {scores.EAT_26_z,scores.AAI_z,scores.OCI_R_z,scores.age_z};
% names = {'EAT-26 score','AAI score', 'OCI-R score','BMI','Age'};
names = {'EAT-26 score','AAI score', 'OCI-R score','Age'};
...
%         barplot(j).FaceAlpha=0.3+0.7*(j-1);
    ...
    title(condnames{k})
    text(-0.2,1.1,charlbl{k},'Units','normalized','FontSize',axisFontSize+5,'FontWeight','bold')
end
rew_1_x = 275;
rew_2_x=910;
rwidth=110;
