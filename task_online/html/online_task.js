...
function instr_prRoutineBegin(trials) {
  return function () {
    ...
    for (const thisComponent of instr_prComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function initialiseRoutineBegin(trials) {
  return function () {
    ...
    for (const thisComponent of initialiseComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function post_stage1RoutineBegin(trials) {
  return function () {
    ...
    for (const thisComponent of post_stage1Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function stage2RoutineBegin(trials) {
  return function () {
    ...
    for (const thisComponent of stage2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function post_stage2RoutineBegin(trials) {
  return function () {
    ...
    for (const thisComponent of post_stage2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
